...
from epytope.Core import Peptide, Protein, Allele
...
class EpitopeAssembly:
    """
        ...
        :param pred: A :class:`~epytope.Core.Base.ACleavageSitePrediction`
        :type pred: :class:`~epytope.Core.Base.ACleavageSitePredictor`
    ...
    def solve(self, options=None):
        ...
        :return: An order list of the :class:`~epytope.Core.Peptide.Peptide` (based on the string-of-beads ordering)
    ...
    def approximate(self):
        ...
        :return: An order list of the :class:`~epytope.Core.Peptide.Peptide` (based on the sting-of-beads ordering)
        :rtype: list(:class:`~epytope.Core.Peptide.Peptide`)
        """
...
class ParetoEpitopeAssembly:
    """
        ...
        :param peptides: A list of :class:`~epytope.Core.Peptide.Peptide` which shell be arranged
        :type peptides: list(:class:`~epytope.Core.Peptide.Peptide`)
        :param cl_pred: A :class:`~epytope.Core.Base.ACleavageSitePrediction`
        :type cl_pred: :class:`~epytope.Core.Base.ACleavageSitePredictor`
        :param ep_pred: A :class:`~epytope.Core.Base.AEpitopePrediction`
        :type ep_pred: :class:`~epytope.Core.Base.AEpitopePrediction`
